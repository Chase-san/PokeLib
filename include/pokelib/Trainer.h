 ...
 *      Author: Chase
 *
 *  Description: This file handles the editing of trainer data. This may be a
 * bit complex since trainer data is split by the party data. As such no
 * specific output file is needed.
 *
 *  This class also handles the item data. Since it fits it pretty nicely.
 *
 *  Just try the best to get it to be able to be put back into save in one
 * piece.
 */
